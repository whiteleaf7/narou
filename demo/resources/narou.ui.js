...
$(document).ready(function() {
  ...
  $("#console").append('<div class="console-line">2巻発売記念</div><div class="console-line">第130部分　あまいたくらみ (130/130)</div><div class="console-line"><span style="color:darkcyan">ID:18　魔王の始め方 は完結しているようです</span></div><div class="console-line">ID:18　魔王の始め方 の変換を開始</div><div class="console-line">小説状態の調査結果を 調査ログ.txt に出力しました</div><div class="console-line">縦書用の変換が終了しました</div><div class="console-line">AozoraEpub3でEPUBに変換しています........変換しました</div><div class="console-line">[笑うヤカン] 魔王の始め方.epub を出力しました</div><div class="console-line"><span style="font-weight:bold"><span style="color:lime">EPUBファイルを出力しました</span></span></div><div class="console-line">ID:10　本好きの下剋上　～司書になるためには手段を選んでいられません～ の変換を開始</div><div class="console-line">縦書用の変換が終了しました</div><div class="console-line">AozoraEpub3でEPUBに変換しています...........変換しました</div><div class="console-line">[香月　美夜] 本好きの下剋上　～司書になるためには手段を選んでいられません～.epub を出力しました</div><div class="console-line"><span style="font-weight:bold"><span style="color:lime">EPUBファイルを出力しました</span></span></div>');
  stream_console.scroll_to_bottom();
