...
<p class="text-right">
<label><input type="checkbox" id="update-gl-narou" checked> なろう小説をAPIで確認</label>
&nbsp;&nbsp;&nbsp;<label><input type="checkbox" id="update-gl-other" checked> その他の小説を確認</label><br>
<label><input type="checkbox" id="update-gl-and-update-modified" checked> 確認後にmodifiedタグが付いた小説をUpdate</label>
</p>
        */}).toString().replace(/(\n)/g, '').split('*')[1],
        backdrop: true,
        buttons: {
