  ...
  $.extend(Tag.prototype, {
    updateCanvas: function() {
      ...
      $.get("/api/tag_list", function(source) {
        ...
        $canvas.html(source);
        self.updateEvents($canvas, false);
      });
    },

    updateEvents: function($target, stop_bubbling) {
      var self = this;
      if (typeof stop_bubbling === "undefined") stop_bubbling = true;
      var finder = function(arg) {
        if (typeof $target === "function")
          return $target(arg);
        else
          return $target.find(arg);
      }
      finder(".tag").on("click", function(e) {
        if (stop_bubbling) e.stopPropagation();
